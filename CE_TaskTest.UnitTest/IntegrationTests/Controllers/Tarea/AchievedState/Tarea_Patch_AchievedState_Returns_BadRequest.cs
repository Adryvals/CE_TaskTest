...
{
    public class Tarea_Patch_AchievedState_Returns_BadRequest
    {
        [Fact]
        public async void Put_AchievedState_Returns_BadRequest()
        {
            ...
            // Act
            var result = await controller.AchievedState(2);
